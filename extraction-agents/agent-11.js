...
class ExtractionAgent11 {
  ...
  async run() {
    ...
    try {
      ...
      console.log('✅ agent-11 완료: ' + questions.length + '개 문제 추출');
      
      // 결과 저장
      await fs.writeFile(
        path.join('/Users/voidlight/tree-doctor-pdf-qa-mcp/extraction-agents', 'agent-11-results.json'),
        JSON.stringify({
          agentId: 'agent-11',
          examYear: 11,
      ...
      console.error('❌ agent-11 오류:', error.message);
    }
  }
...
// 실행
const agent = new ExtractionAgent11();
